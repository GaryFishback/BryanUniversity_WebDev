...
function UList(props) {
  ...
  return (
    <ul className={props.className}>
      <li style={{ backgroundColor: props.BackgroundColor }} className="li1">
        {props.li1}
      </li>
      <li style={{ backgroundColor: props.BackgroundColor }} className="li2">
        {props.li2}
      </li>
      <li style={{ backgroundColor: props.BackgroundColor }} className="li3">
        {props.li3}
      </li>
