...
import FullTweet from "./../Tweets/Details/FullTweet";
...
function Home(props) {
  const [tweets, setTweets] = useState(data.data.statuses);
    ...
    <div>
      ...
      <section>
        <div id="form_div">
          ...
          <input
            placeholder="What’s happening?-This is not real twitter, so i need a second input field for your name :)"
            onKeyDown={e => {
              // console.log(e.key);
              if (e.key === "Enter") {
                setTweet = tweetText => {
          ...
          <svg
            ...
            onClick={() => {
              ...
              imgUrlInput.placeholder = "Img URL goes here";
