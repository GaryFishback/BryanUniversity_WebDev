    ...
    return (
      <div>
        <article
          ...
          data-focusable="true"
          tabindex="0"
          className="css-1dbjc4n r-1loqt21 r-1udh08x r-o7ynqc r-1j63xyz"
        >
          <a
            aria-haspopup="false"
            href="/TwitterBusiness"
            role="link"
            data-focusable="true"
          ...
          >
            <img
              alt=""
              draggable="true"
              src="https://pbs.twimg.com/profile_images/941415294794317824/gaj36XL5_bigger.jpg"
          ...
          >
            <span className="css-901oao css-16my406 r-1qd0xha r-ad9z0x r-bcqeeo r-qvutc0">
              Get the most out of Twitter Ads with personalized tips for your
              campaigns.
            </span>
          </div>

          <a
            href="https://t.co/LpXLdoTkRX?amp=1"
            target="_blank"
            role="link"
            data-focusable="true"
            className="css-4rbku5 css-18t94o4 css-1dbjc4n r-1loqt21 r-1pi2tsx r-1udh08x r-13qz1uu"
            rel=" noopener noreferrer"
          >
            <img
              alt=""
              draggable="true"
              src="https://pbs.twimg.com/ad_img/1195971094508818432/T_75d0yJ?format=jpg&amp;name=small"
              className="css-9pa8cd"
            ></img>
          </a>
          ...
          <a
            ...
            role="link"
            data-focusable="true"
            className="css-4rbku5 css-18t94o4 css-1dbjc4n r-1loqt21 r-18u37iz r-16y2uox r-1wtj0ep"
            rel=" noopener noreferrer"
          >
            <span className="css-901oao css-16my406 r-1qd0xha r-ad9z0x r-bcqeeo r-qvutc0">
              Contact the Twitter Ads team
            </span>
